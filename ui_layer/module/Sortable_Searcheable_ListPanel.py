...
list_cache=join('ui_cache','GH', 'list_objects', 'List_Objects_Center_2.json')
...
#---------------------------------------------------------------------------
class Sortable_Searcheable_ListPanel(wx.Panel, Controller, listmix.ColumnSorterMixin):
    def __init__(self,  **kwargs):
        ...
        self.rows=[]
        self.header=[]
        #self.slist = slist = Sortable_Searcheable_ListCtrl(self)
        ...
        self.Bind(wx.EVT_LIST_COL_CLICK, self.OnColClick, self.slist)
