...
e=sys.exit
from ui_layer.module.Sortable_Searcheable_ListPanel import Sortable_Searcheable_ListPanel
...
#---------------------------------------------------------------------------
class SortableSearcheableFrame(wx.Panel, Base, EditMenu, DoubleClick):
    ...
    def __init__(self,  **kwargs):
        ...
        self.slp = slp = Sortable_Searcheable_ListPanel(parent=self)
...
#---------------------------------------------------------------------------
def runTest(**kwargs):
    win = SortableSearcheableFrame(**kwargs)
