...
from ui_layer.module.controller.Searcheable_TreeCtrl_Controller import Controller
from ui_layer.module.Searcheable_TreeCtrl import Searcheable_TreeCtrl
...
def DoesModifiedExist(name):
    ...
    if os.path.exists(GetModifiedFilename(name)):
        ...
        return False
#---------------------------------------------------------------------------
class Searcheable_Tree(Controller):
    def __init__(self, parent):
        def EmptyHandler(evt): pass
        self.parent=parent
        self.ReadConfigurationFile()
        
        self.tree = Searcheable_TreeCtrl(parent)
