...
from ui_layer.utils import ex, load_pipeline_module
...
e=sys.exit
#from ui_layer.module.Sortable_ListPanel import Sortable_ListPanel
Sortable_ListPanel = load_pipeline_module(uic, 'Sortable_ListPanel')
list_cache=join('ui_cache','GH', 'list_objects', 'List_Objects_Center_1.json')

#---------------------------------------------------------------------------
class ListCtrl_Frame(wx.Panel, Base, EditMenu, DoubleClick):
    ...
    def __init__(self,  **kwargs):
        ...
        self.slp = slp = Sortable_ListPanel(parent=self)
